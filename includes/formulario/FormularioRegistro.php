...
class FormularioRegistro extends Formulario
{
    ...
    {
        parent::__construct('formRegistro', ['urlRedireccion' => RUTA_APP . '/view/login_pantalla.php']);
    }
    ...
    protected function procesaFormulario(&$datos)
    {
        ...
        if (count($this->errores) === 0) {
            ...
            $usuario = new Usuario($userid, $contrasena, $email, $nombre, $apellidos, (int)$edad, 'usuario');
            $usuarioSA = new RegistroSA();
            
            if (!$usuarioSA->registrarUsuario($usuario)) {
                $this->errores[] = "Error al registrar el usuario o el usuario ya existe";
            } else {
